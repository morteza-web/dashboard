...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, toggleSidebar }) => {
    return (
        <div
            className={`fixed top-0 left-0 z-10 w-64 h-full bg-gray-800 text-white transition-transform transform ${
        ...
        >
            <div className="flex justify-between p-4 border-b border-gray-700 relative">
                ...
                <button
                    ...
                    className="md:hidden text-black absolute top-4 -right-8"
                >
